          ...
          <CardContent className="p-8 space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-gray-700">
                    ...
                    <li><strong>• 배송 후 7일 이내:</strong> 상품 미개봉 시 반품 가능 (왕복 배송비 고객 부담)</li>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  ...
                  <p className="text-xs text-gray-600 mt-2">
                    * 각 팝업 스토어 상품의 상세 페이지에서 해당 상품의 취소/환불 정책을 반드시 확인하세요.
                  </p>
                </div>
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-gray-700">
                    ...
                    <li><strong>• 보증금:</strong> 차량 반납 후 이상 없을 시 7일 이내 환불</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>신용카드 결제: 승인 후 3-5영업일 (카드사 정책에 따라 차이 있음)</li>
                  <li>계좌이체: 승인 후 3영업일 이내</li>
                  <li>간편결제 (토스페이 등): 승인 후 즉시-3영업일</li>
                  <li>포인트: 승인 즉시 복구</li>
                </ul>
                <p className="leading-relaxed">
                  <strong>4. 부분 환불</strong><br />
                  취소 수수료가 발생하는 경우, 결제 금액에서 수수료를 차감한 금액이 환불됩니다.
            ...
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                <p className="leading-relaxed">
                  <strong>1. 고객 변심:</strong> 왕복 배송비(통상 6,000원) 고객 부담
                </p>
                <p className="leading-relaxed">
                  <strong>2. 상품 하자/오배송:</strong> 배송비 전액 판매자 부담
                </p>
                <p className="leading-relaxed">
                  <strong>3. 교환 시:</strong> 추가 배송비 발생 (편도 3,000원)
                </p>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                「전자상거래 등에서의 소비자보호에 관한 법률」 제18조에 따라 회사는
                환불이 지연되는 경우 지연기간에 대하여 연 15%의 지연배상금을 지급합니다.
                다만, 회사의 귀책사유가 없는 경우에는 그러하지 아니합니다.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">제9조 (정책 변경)</h2>
              <p className="text-gray-700 leading-relaxed">
