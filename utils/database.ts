...
class PlanetScaleDatabase {
  ...
  private getPartnerListings() {
    return [
      ...
      // 1. 여행 (tour) - 4개
      {
        ...
        rating_avg: 5.0, rating_count: 1, is_published: true, is_featured: true,
      ...
      // 2. 렌트카 (rentcar) - 4개
      {
        ...
        rating_avg: 5.0, rating_count: 1, is_published: true, is_featured: false,
      ...
      },
      {
        ...
        rating_avg: 0.0, rating_count: 0, is_published: true, is_featured: true,
      ...
      },
      {
        ...
        rating_avg: 0.0, rating_count: 0, is_published: true, is_featured: false,
      ...
      },
      {
        ...
        rating_avg: 4.4, rating_count: 0, is_published: true, is_featured: false,
      ...
      },
      {
        ...
        rating_avg: 4.7, rating_count: 0, is_published: true, is_featured: true,
      ...
      },
      {
        ...
        rating_avg: 4.5, rating_count: 0, is_published: true, is_featured: false,
        images: '["https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400"]'
      },
      {
        ...
        rating_avg: 4.6, rating_count: 0, is_published: true, is_featured: true,
        images: '["https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400"]'
      },
      {
      ...
      },
      {
        ...
        rating_avg: 4.3, rating_count: 0, is_published: true, is_featured: false,
        images: '["https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400"]'
      },
      {
        ...
        rating_avg: 4.9, rating_count: 0, is_published: true, is_featured: true,
        images: '["https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400"]'
      },
      {
      ...
      },
      {
        ...
        rating_avg: 4.6, rating_count: 0, is_published: true, is_featured: false,
        images: '["https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400"]'
      },
      {
        ...
        rating_avg: 4.2, rating_count: 0, is_published: true, is_featured: false,
        images: '["https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400"]'
      },
      {
      ...
      },
      {
        ...
        rating_avg: 4.7, rating_count: 0, is_published: true, is_featured: false,
        images: '["https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400"]'
      },
      {
        ...
        location: '신안군 기점면', lat: 34.2531, lng: 126.1161, duration: '1박', max_capacity: 6,
        short_description: '바다 위에서 즐기는 특별한 요트 숙박 체험',
        rating_avg: 4.8, rating_count: 0, is_published: true, is_featured: true,
        images: '["https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400"]'
      },
      {
      ...
      // 팝업 (popup) - 4개
      {
        ...
        rating_avg: 4.5, rating_count: 0, is_published: true, is_featured: true,
        images: '["https://images.unsplash.com/photo-1559056961-84042b4bdcd8?w=400"]'
      },
      {
    ...
    return [
      {
        ...
        rating: 5,
        title: '최고의 투어 체험!',
        content: '증도 천일염 체험이 정말 최고였어요! 전통적인 소금 만들기 과정을 직접 체험할 수 있어서 아이들과 함께하기에 완벽했습니다. 가이드님도 친절하시고 기념품까지 받아서 만족스러웠어요.',
        ...
        listing_title: '증도 천일염 체험여행',
        user_name: '김민지',
        listing_location: '신안군 증도면',
        listing_images: '["https://images.unsplash.com/photo-1518098268026-4e89f1a2cd8e?w=400"]'
      },
      {
        id: 2,
        listing_id: 11,
        ...
        rating: 5,
        title: '완벽한 숙박!',
        content: '기점도 요트 펜션에서 머물렀는데 정말 완벽했어요. 바다 위에서의 특별한 경험이었고 시설도 깔끔했습니다. 아침에 일어나서 바로 바다를 볼 수 있어서 힐링되었어요.',
        ...
        listing_title: '기점도 요트 펜션',
        user_name: '박정훈',
        listing_location: '신안군 기점면',
        listing_images: '["https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400"]'
      },
      {
        id: 3,
        listing_id: 13,
        ...
        listing_title: '신안 전통 젓갈 맛집',
        user_name: '이수연',
        listing_location: '신안군 지도읍',
        listing_images: '["https://images.unsplash.com/photo-1544025162-d76694265947?w=400"]'
      },
      {
        id: 4,
        listing_id: 2,
        ...
        rating: 5,
        title: '홍도의 절경!',
        content: '홍도 해상국립공원 여행은 정말 볼거리가 많았어요. 아름다운 기암절벽과 해안 절경이 장관이었고, 유람선에서 바라본 풍경은 평생 잊을 수 없을 것 같아요.',
        ...
        listing_title: '홍도 해상국립공원 여행',
        user_name: '최동하',
        listing_location: '신안군 홍도면',
        listing_images: '["https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400"]'
      },
      {
        id: 5,
        listing_id: 3,
        ...
        rating: 5,
        title: '교육적인 체험!',
        content: '자라도 갯벌 생태여행이 정말 유익했어요. 아이들과 함께 참여했는데 갯벌 생태계를 직접 볼 수 있어서 좋은 교육이 되었습니다. 체험 프로그램도 잘 준비되어 있었어요.',
        images: '["https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=100&h=100&fit=crop&crop=face"]',
        ...
        listing_title: '자라도 갯벌 생태여행',
        user_name: '정미경',
        listing_location: '신안군 자라면',
        listing_images: '["https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400"]'
      },
      {
        id: 6,
        listing_id: 5,
        ...
        rating: 5,
        title: '환상적인 드라이브!',
        content: '신안 아일랜드 렌트카로 섬 여행을 했는데 정말 환상적이었어요! 깨끗한 차량과 친절한 서비스가 인상적이었습니다. 드라이브 코스 안내도 잘 되어 있었어요.',
        images: '["https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face"]',
        visit_date: '2024-03-03',
        is_verified: 1,
        helpful_count: 9,
        is_visible: 1,
        response_from_partner: '좋은 추억 만드셨길 바랍니다!',
        created_at: '2024-03-03T15:20:00Z',
        updated_at: '2024-03-03T15:20:00Z',
        listing_title: '신안 아일랜드 렌트카',
        user_name: '김민지',
        listing_location: '신안군 지도읍',
        listing_images: '["https://images.unsplash.com/photo-1549924231-f129b911e442?w=400"]'
      },
      {
        id: 7,
        listing_id: 17,
        ...
        rating: 5,
        title: '태평염전의 감동!',
        content: '증도 태평염전 관람이 정말 감동적이었어요. 아시아 최대 규모의 천일염전과 염전 박물관에서 많은 것을 배웠습니다. 아이들에게 좋은 교육 장소네요.',
        images: '["https://images.unsplash.com/photo-1494790108755-2616b612b641?w=100&h=100&fit=crop&crop=face"]',
      ...
      },
      {
        ...
        rating: 5,
        title: '슬로우길의 매력!',
        content: '청산도 슬로우길 여행에서 정말 많은 것을 느꼈어요. 영화 촬영지로 유명한 곳답게 아름다운 풍경이 곳곳에 있었습니다. 천천히 걸으며 힐링할 수 있었어요.',
        images: '["https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face"]',
        ...
        listing_title: '청산도 슬로우길 여행',
        user_name: '이수연',
        listing_location: '신안군 청산면',
        listing_images: '["https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400"]'
      }
    ];
  }
  ...
  private getMockResult(sql: string, params: any[] = []) {
    ...
    if (lowerSql.includes('select') && lowerSql.includes('reviews')) {
      return {
        rows: this.getMockReviews()
      };
    }
