/**
 * 숙박 벤더 - 숙소 관리 API
 * GET /api/vendor/lodging/properties - 벤더의 숙소 목록 조회
 * POST /api/vendor/lodging/properties - 새 숙소 추가
 */
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'GET') {
      // 벤더의 숙소 목록 조회 (listings 테이블에서 category='숙박')
      ...
      const lodgings = (result || []).map(row => {
        ...
        return {
          ...
          room_count: row.booking_count || 0,
    ...
    if (req.method === 'POST') {
      ...
      console.log('✅ [Lodging Properties] 숙소 추가 완료:', { vendorId, listingId: result.insertId });
    ...
    console.error('❌ [Lodging Properties API] 오류:', error);
