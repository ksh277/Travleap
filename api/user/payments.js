  ...
  try {
    ...
    const result = await connection.execute(`
      SELECT
        ...
        p.booking_id,
        p.order_id,
        p.order_id_str COLLATE utf8mb4_unicode_ci as order_id_str,
        ...
        p.approved_at,
        p.receipt_url,
        p.card_company COLLATE utf8mb4_unicode_ci as card_company,
        p.card_number COLLATE utf8mb4_unicode_ci as card_number,
        p.created_at,
        p.notes,
        p.refund_amount,
        p.refund_reason,
        p.refunded_at,
        b.booking_number COLLATE utf8mb4_unicode_ci as booking_number,
        b.listing_id,
        b.start_date,
        b.end_date,
        ...
        b.children,
        b.infants,
        l.title COLLATE utf8mb4_unicode_ci as listing_title,
        l.category COLLATE utf8mb4_unicode_ci as category,
        l.images COLLATE utf8mb4_unicode_ci as listing_images,
      ...
      SELECT
        ...
        p.refund_reason,
        p.refunded_at,
        rb.booking_number COLLATE utf8mb4_unicode_ci as booking_number,
        NULL as listing_id,
        ...
        NULL as children,
        NULL as infants,
        v.display_name COLLATE utf8mb4_unicode_ci as listing_title,
        CAST('렌트카' AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as category,
        NULL as listing_images,
        v.display_name COLLATE utf8mb4_unicode_ci as vehicle_name,
        rb.pickup_date,
        rb.dropoff_date
      FROM payments p
